...
class GraphFADE(torch.nn.Module):
    def __init__(self, args, n_sample, n_feature, n_class, feature_corr):
        ...
        self.prop = Propagation(alpha=args.alpha)
        self.beta = args.beta
        ...
        for _ in range(self.n_pool):
            ...
            self.pools.append(ClusteringLayer(args.mlp_cluster, n_feature, args.n_hidden, n_centroid))

        self.mlp = MLP(args.mlp_out, 2 * n_feature, args.n_hidden, n_class)
